const CACHE='medical-recall-studio-v2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data/recalls-data.js','./assets/logo.png','./assets/icon-192.png','./assets/icon-512.png','./docs/readable-edition.pdf'];
