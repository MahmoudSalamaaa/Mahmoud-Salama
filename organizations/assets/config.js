...
export const NAV_ITEMS = [
  ...
  ['medical-companies.html','Medical','الطبي'],
  ['recruitment-agencies.html','Recruitment','التوظيف'],
  ['government-jobs.html','Government','الحكومي'],
  ['private-company-directory.html','Companies','الشركات'],
  ['platform-search-hub.html','Search Matrix','مصفوفة البحث'],
  ['project-opportunities.html','Projects','المشروعات'],
